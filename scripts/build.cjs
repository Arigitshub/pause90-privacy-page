...
for (const name of ['index.html', 'kit.html', 'one-tiny-win.html', 'Pause90_One_Tiny_Win_Sample_v1.pdf', 'one-tiny-win-preview.png', 'make-a-task-smaller.html', 'sitemap.xml']) {
